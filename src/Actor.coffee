...
WebActors._unregisterGateway = unregisterGateway
WebActors._setDefaultGateway = setDefaultGateway
WebActors._getLocalPrefix = getLocalPrefix
WebActors._setLocalPrefix = setLocalPrefix
WebActors._allocateChildPrefix = allocateChildPrefix
WebActors._reportError = reportError
WebActors._setErrorHandler = setErrorHandler
